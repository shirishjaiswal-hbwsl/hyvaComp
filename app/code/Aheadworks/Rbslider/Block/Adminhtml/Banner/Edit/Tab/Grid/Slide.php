...
class Slide extends GridExtended
{
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($column->getId() == 'slide_ids') {
            ...
            if ($column->getFilter()->getValue()) {
                $this->getCollection()->addFieldToFilter(SlideInterface::ID, ['in' => $slidesIds]);
            } elseif (!empty($slidesIds)) {
                $this->getCollection()->addFieldToFilter(SlideInterface::ID, ['nin' => $slidesIds]);
            }
    ...
    {
        if ($column->getFilter()->getValue() != Store::DEFAULT_STORE_ID) {
            $collection->addFieldToFilter('store_id', (int)$column->getFilter()->getValue());
        }
